...
module.exports = {
    mtransfer_gaslimit_too_low: async function mtransfer_gaslimit_too_low(accounts, expect) {
        ...
        await expect(daiplus_instance.verifyTransfer(
            ...
            , {
                from: accounts[1],
                gasPrice,
                gas: Math.floor(gasLimit * 0.9)
            })).to.eventually.be.rejectedWith('DaiPlus::gasBarrier | insufficient gas provided by the relayer');
