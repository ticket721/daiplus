...
module.exports = {
    mtransfer_gasprice_too_low: async function mtransfer_gasprice_too_low(accounts, expect) {
        ...
        await expect(daiplus_instance.verifyTransfer(
            ...
            , {
                from: accounts[1],
                gasPrice: Math.floor(gasPrice * 0.9)
            })).to.eventually.be.rejectedWith('DaiPlus::gasBarrier | insufficient gasPrice provided by the relayer');
