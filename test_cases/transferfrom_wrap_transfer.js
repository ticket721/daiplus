module.exports = {
    transferfrom_wrap_transfer: async function transferfrom_wrap_transfer(accounts, expect) {
        ...
        await daiplus_instance.transferFrom(to, accounts[1], amount, { from: accounts[0] });
        ...
        expect((await daiplus_instance.balanceOf(accounts[1])).toNumber()).to.equal(amount);
