...
module.exports = {
    mtransfer_invalid_signature: async function mtransfer_invalid_signature(accounts, expect) {
        ...
        await expect(daiplus_instance.verifyTransfer(
            ...
            ZEROSIG
            , {from: accounts[1], gasPrice})).to.eventually.be.rejectedWith('DaiPlus::verifyTransfer | invalid signer')
        ...
        await expect(daiplus_instance.signedTransfer(
            ...
            ZEROSIG
            , {from: accounts[1], gasPrice})).to.eventually.be.rejectedWith('DaiPlus::_signedTransfer | invalid signer')
