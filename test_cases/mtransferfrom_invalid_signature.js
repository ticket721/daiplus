...
module.exports = {
    mtransferfrom_invalid_signature: async function mtransferfrom_invalid_signature(accounts, expect) {
        ...
        await expect(daiplus_instance.verifyTransferFrom(
            [
            ...
            , {
                from: accounts[2],
                gasPrice
            })).to.eventually.be.rejectedWith('DaiPlus::verifyTransferFrom | invalid signer');

        // Execute Meta Transaction
        await expect(daiplus_instance.signedTransferFrom(
            [
                mTransferFromPayload.actors.signer,
                mTransferFromPayload.actors.relayer,
                mTransferFromPayload.sender,
            ...
            , {
                from: accounts[2],
                gasPrice
            })).to.eventually.be.rejectedWith('DaiPlus::_signedTransferFrom | invalid signe')
