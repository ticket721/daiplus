...
module.exports = {
    mtransfer_replay_attack: async function mtransfer_replay_attack(accounts, expect) {
        ...
        await expect(daiplus_instance.verifyTransfer(
            ...
            signature.hex
            , {from: accounts[1], gasPrice})).to.eventually.be.fulfilled;


        // Execute Failing Meta Transaction
        await expect(daiplus_instance.signedTransfer(
            ...
            signature.hex
            , {from: accounts[1], gasPrice})).eventually.be.fulfilled;
