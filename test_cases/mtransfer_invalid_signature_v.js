...
module.exports = {
    mtransfer_invalid_signature_v: async function mtransfer_invalid_signature_v(accounts, expect) {
        ...
        await expect(daiplus_instance.verifyTransfer(
            ...
            `${signature.hex.slice(0, 130)}ff`
            , {
                from: accounts[1],
                gasPrice
            })).to.eventually.be.rejectedWith('DaiPlus::_splitSignature | invalid v argument')
