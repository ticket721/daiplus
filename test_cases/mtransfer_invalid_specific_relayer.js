...
module.exports = {
    mtransfer_invalid_specific_relayer: async function mtransfer_invalid_specific_relayer(accounts, expect) {
        ...
        await expect(daiplus_instance.verifyTransfer(
            ...
            , {
                from: accounts[1],
                gasPrice
            })).to.eventually.be.rejectedWith('DaiPlus::relayerBarrier | relayer restriction not met')
