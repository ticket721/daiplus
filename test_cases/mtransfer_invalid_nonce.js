...
const {ZERO, domain} = require('./utils');

module.exports = {
    mtransfer_invalid_nonce: async function mtransfer_invalid_nonce(accounts, expect) {
        ...
        const mTransferPayload = {
            ...
            txparams: {
                nonce: parseInt(await daiplus_instance.nonceOf(wallet.address)) + 1,
                gasLimit: 1000000,
                gasPrice,
                reward: 100000,
            }
        ...
        await expect(daiplus_instance.verifyTransfer(
            ...
            signature.hex
            , {from: accounts[1], gasPrice})).to.eventually.be.rejectedWith('DaiPlus::nonceBarrier | invalid nonce');
        ...
        await expect(daiplus_instance.signedTransfer(
            ...
            signature.hex
            , {from: accounts[1], gasPrice})).eventually.be.rejectedWith('DaiPlus::nonceBarrier | invalid nonce');
